...
movies = pd.read_csv('/Users/shivam/Downloads/WarlikeGreedyComputerscience-2/tmdb_5000_movies.csv')
credits = pd.read_csv('/Users/shivam/Downloads/WarlikeGreedyComputerscience-2/tmdb_5000_credits.csv')
